...
public class Player extends Image {
	...
	public void reactOnClick() {
		...
		Action moveAction = Actions.sequence(
				Actions.moveBy(xMoveAmmount, yMoveAmmount, moveActionTime, Interpolation.pow3Out),
				Actions.moveBy(-xMoveAmmount, -yMoveAmmount, moveActionTime, Interpolation.pow3In));

		int xGrowAmmount = MathUtils.random(-30, 100);
		int yGrowAmmount = 20;
		float growActionTime = 0.2f;
		Action growAction = Actions.sequence(
				Actions.sizeBy(xGrowAmmount, yGrowAmmount, growActionTime, Interpolation.pow3Out),
				Actions.sizeBy(-xGrowAmmount, -yGrowAmmount, growActionTime, Interpolation.pow3In));
